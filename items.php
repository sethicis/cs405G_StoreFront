...
function addEditButton(){
    if ($_GET['edit'] == 'yes'){
        echo "<a class='btn' href='items.php?edit=no'>Turn <font style='color:green;'>ON</font> Edit Mode</a>";
    }else{
        echo "<a class='btn' href='items.php?edit=yes'>Turn <font style='color:red;'>OFF</font> Edit Mode</a>";
    }
}
